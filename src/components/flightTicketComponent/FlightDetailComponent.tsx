...
import { dataFromFlight } from "../../redux/dataReducer/dataReducer";
...
export default function FlightDetailComponent({ }: Props) {
  const settings = {
    dots: false,
    infinite: false,
    slidesToShow: 6,
  ...
  const handleSubmit = async () => {
    await dispatch(dataFromFlight({
      name_flight: 'Bamboo Airways',
      price: '2.517.000',
      fligth_type: 'bay đi',
      depature_airport: 'Tân Sơn Nhất',
      arrival_airport: 'Nội Bài',
      depature_time: '22:25',
      arrival_time: '14:50',
  ...
  const returnFlight = useSelector((state: RootState) => state.testData.returnDate)
      ...
      <div className="detail">
        ...
        >
            ...
            <div className="col left">
              <div className="row">
                <div className="col text-center">
                  <p className="font-medium text-base mb-2">22:25</p>
                ...
                <div className="col text-center">
                  <p className="font-medium text-base mb-2">14:50</p>
                  <p className="inline-block py-1 px-2 bg-gray-200 rounded-3xl font-medium text-gray-500">
                    SGN
                  </p>
                </div>
          ...
          <div className="text-right" onClick={handleSubmit}>
            <NavLink
              // to="/flightreturn"
              to={`${returnFlight == '0' ? '/info' : '/flightreturn'}`}
