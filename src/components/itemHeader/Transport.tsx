...
import { BsFillBusFrontFill, BsFillCarFrontFill } from 'react-icons/bs'
...
export default function Transport({ }: Props) {
     return (
          <div>
               ...
               <div className="flex items-center mb-3">
                    <span className="mr-3"><BsFillCarFrontFill/></span>
                    <h4>Đưa đón sân bay</h4>
               </div>

               <div className="flex items-center mb-3">
                    <span className="mr-3"><BsFillBusFrontFill/></span>
                    <h4>Bus & Shuttle</h4>
               </div>
          </div>
     )
