...
export default function Header({ }: Props) {
     ...
     return (
          <div className='relative container-fluid header border-t-4 border-blue-500 font-medium'>
               <div className='absolute top-0 bottom-0 left-0 right-0 bg-white' style={{zIndex:'999'}}></div>
               ...
               <div className=' container-fluid headerBottom bg-gray-100 py-1.5'>
