...
export default function HotelPartner({ }: Props) {
     ...
     return (
          <div className='mb-28 hotel'>
               <div className='row'>
                    <div className="col-4 pt-3">
                         <div>
                              <p className='text-2xl font-bold mb-2'>Đối tác khách sạn</p>
                              <p className='text-gray-500 text-sm font-semibold my-3'>Đối tác khách sạn trong nước và quốc tế</p>
                              <p className='text-base font-medium leading-6'>Chúng tôi hợp tác với các chuỗi khách sạn trên toàn thế giới để bảo đảm mang lại kỳ nghỉ tuyệt vời nhất tại mọi điểm đến trong mơ của bạn!</p>
